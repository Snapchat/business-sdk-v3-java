...
public class EventLogs {
  ...
  public EventLogs event(@javax.annotation.Nullable Integer event) {
    this.event = event;
    return this;
  }
  ...
  public EventLogs status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public EventLogs errors(@javax.annotation.Nullable ErrorDetails errors) {
    this.errors = errors;
    return this;
  }
  ...
  public EventLogs warnings(@javax.annotation.Nullable List<String> warnings) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventLogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventLogs is not found in the empty JSON string", EventLogs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventLogs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventLogs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EventLogs>() {
           @Override
