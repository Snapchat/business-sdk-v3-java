...
public class CapiEvent {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventName, eventTime, actionSource, eventId, eventSourceUrl, optOut, dataProcessingOptions, userData, customData, rawRequest, appData, assetId, requestId, integration);
  }
