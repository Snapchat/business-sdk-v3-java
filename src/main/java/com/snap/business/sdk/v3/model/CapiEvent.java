...
public class CapiEvent {
  ...
  @javax.annotation.Nullable
  private List<String> dataProcessingOptions = new ArrayList<>();
  ...
  public CapiEvent eventName(@javax.annotation.Nullable String eventName) {
  ...
  public CapiEvent eventTime(@javax.annotation.Nullable Long eventTime) {
  ...
  public CapiEvent actionSource(@javax.annotation.Nullable String actionSource) {
  ...
  public void setActionSource(@javax.annotation.Nullable String actionSource) {
    this.actionSource = actionSource;
  }


  public CapiEvent eventId(@javax.annotation.Nullable String eventId) {
  ...
  public CapiEvent eventSourceUrl(@javax.annotation.Nullable String eventSourceUrl) {
  ...
  public CapiEvent optOut(@javax.annotation.Nullable Boolean optOut) {
    this.optOut = optOut;
    return this;
  }
  ...
  public CapiEvent dataProcessingOptions(@javax.annotation.Nullable List<String> dataProcessingOptions) {
  ...
  public void setDataProcessingOptions(@javax.annotation.Nullable List<String> dataProcessingOptions) {
    this.dataProcessingOptions = dataProcessingOptions;
  }


  public CapiEvent userData(@javax.annotation.Nullable UserData userData) {
  ...
  public void setUserData(@javax.annotation.Nullable UserData userData) {
    this.userData = userData;
  }


  public CapiEvent customData(@javax.annotation.Nullable CustomData customData) {
  ...
  public void setCustomData(@javax.annotation.Nullable CustomData customData) {
    this.customData = customData;
  }


  public CapiEvent rawRequest(@javax.annotation.Nullable String rawRequest) {
  ...
  public void setRawRequest(@javax.annotation.Nullable String rawRequest) {
    this.rawRequest = rawRequest;
  }


  public CapiEvent appData(@javax.annotation.Nullable AppData appData) {
  ...
  public void setAppData(@javax.annotation.Nullable AppData appData) {
    this.appData = appData;
  }


  public CapiEvent assetId(@javax.annotation.Nullable String assetId) {
  ...
  public CapiEvent requestId(@javax.annotation.Nullable String requestId) {
  ...
  public CapiEvent integration(@javax.annotation.Nullable String integration) {
  ...
  public CapiEvent testEventCode(@javax.annotation.Nullable String testEventCode) {
  ...
  public void setTestEventCode(@javax.annotation.Nullable String testEventCode) {
    this.testEventCode = testEventCode;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventName, eventTime, actionSource, eventId, eventSourceUrl, optOut, dataProcessingOptions, userData, customData, rawRequest, appData, assetId, requestId, integration, testEventCode);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapiEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CapiEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CapiEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("action_source") != null && !jsonObj.get("action_source").isJsonNull()) && !jsonObj.get("action_source").isJsonPrimitive()) {
      ...
      if (jsonObj.get("data_processing_options") != null && !jsonObj.get("data_processing_options").isJsonNull() && !jsonObj.get("data_processing_options").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `data_processing_options` to be an array in the JSON string but got `%s`", jsonObj.get("data_processing_options").toString()));
      }
      ...
      if ((jsonObj.get("raw_request") != null && !jsonObj.get("raw_request").isJsonNull()) && !jsonObj.get("raw_request").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `raw_request` to be a primitive type in the JSON string but got `%s`", jsonObj.get("raw_request").toString()));
      }
