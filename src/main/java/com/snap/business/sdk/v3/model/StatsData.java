...
public class StatsData {
  ...
  public StatsData test(@javax.annotation.Nullable StatsResponse test) {
    this.test = test;
    return this;
  }
  ...
  public void setTest(@javax.annotation.Nullable StatsResponse test) {
    this.test = test;
  }


  public StatsData live(@javax.annotation.Nullable StatsResponse live) {
    this.live = live;
    return this;
  }
  ...
  public void setLive(@javax.annotation.Nullable StatsResponse live) {
    this.live = live;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatsData is not found in the empty JSON string", StatsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
