...
public class Content {
  ...
  public Content quantity(@javax.annotation.Nullable String quantity) {
  ...
  public Content itemPrice(@javax.annotation.Nullable String itemPrice) {
  ...
  public Content deliveryCategory(@javax.annotation.Nullable String deliveryCategory) {
  ...
  public Content brand(@javax.annotation.Nullable String brand) {
    this.brand = brand;
    return this;
  }
