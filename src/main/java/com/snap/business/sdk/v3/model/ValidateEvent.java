...
public class ValidateEvent {
  ...
  @javax.annotation.Nullable
  private List<String> warningRecords = new ArrayList<>();
  ...
  public ValidateEvent eventName(@javax.annotation.Nullable String eventName) {
  ...
  public ValidateEvent eventTime(@javax.annotation.Nullable String eventTime) {
  ...
  public ValidateEvent actionSource(@javax.annotation.Nullable String actionSource) {
  ...
  public ValidateEvent status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public ValidateEvent integration(@javax.annotation.Nullable String integration) {
  ...
  public ValidateEvent eventMetadata(@javax.annotation.Nullable EventMetadata eventMetadata) {
  ...
  public ValidateEvent warningRecords(@javax.annotation.Nullable List<String> warningRecords) {
  ...
  public void setWarningRecords(@javax.annotation.Nullable List<String> warningRecords) {
    this.warningRecords = warningRecords;
  }


  public ValidateEvent assetId(@javax.annotation.Nullable String assetId) {
  ...
  public ValidateEvent rawEventName(@javax.annotation.Nullable String rawEventName) {
  ...
  public void setRawEventName(@javax.annotation.Nullable String rawEventName) {
    this.rawEventName = rawEventName;
  }


  public ValidateEvent errorRecords(@javax.annotation.Nullable List<String> errorRecords) {
  ...
  public void setErrorRecords(@javax.annotation.Nullable List<String> errorRecords) {
    this.errorRecords = errorRecords;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventName, eventTime, actionSource, status, integration, eventMetadata, warningRecords, assetId, rawEventName, errorRecords);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidateEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValidateEvent is not found in the empty JSON string", ValidateEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidateEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidateEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("warning_records") != null && !jsonObj.get("warning_records").isJsonNull() && !jsonObj.get("warning_records").isJsonArray()) {
      ...
      if ((jsonObj.get("raw_event_name") != null && !jsonObj.get("raw_event_name").isJsonNull()) && !jsonObj.get("raw_event_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `raw_event_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("raw_event_name").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("error_records") != null && !jsonObj.get("error_records").isJsonNull() && !jsonObj.get("error_records").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidateEvent>() {
           @Override
