...
public class AppData {
  ...
  public AppData extinfo(@javax.annotation.Nullable List<String> extinfo) {
  ...
  public void setExtinfo(@javax.annotation.Nullable List<String> extinfo) {
    this.extinfo = extinfo;
  }


  public AppData campaignIds(@javax.annotation.Nullable String campaignIds) {
  ...
  public void setCampaignIds(@javax.annotation.Nullable String campaignIds) {
    this.campaignIds = campaignIds;
  }


  public AppData installReferrer(@javax.annotation.Nullable String installReferrer) {
  ...
  public void setInstallReferrer(@javax.annotation.Nullable String installReferrer) {
    this.installReferrer = installReferrer;
  }


  public AppData installerPackage(@javax.annotation.Nullable String installerPackage) {
  ...
  public void setInstallerPackage(@javax.annotation.Nullable String installerPackage) {
    this.installerPackage = installerPackage;
  }


  public AppData urlSchemes(@javax.annotation.Nullable List<String> urlSchemes) {
  ...
  public void setUrlSchemes(@javax.annotation.Nullable List<String> urlSchemes) {
    this.urlSchemes = urlSchemes;
  }


  public AppData windowsAttributionId(@javax.annotation.Nullable String windowsAttributionId) {
  ...
  public void setWindowsAttributionId(@javax.annotation.Nullable String windowsAttributionId) {
    this.windowsAttributionId = windowsAttributionId;
  }


  public AppData appId(@javax.annotation.Nullable String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public AppData advertiserTrackingEnabled(@javax.annotation.Nullable Boolean advertiserTrackingEnabled) {
  ...
  public void setAdvertiserTrackingEnabled(@javax.annotation.Nullable Boolean advertiserTrackingEnabled) {
    this.advertiserTrackingEnabled = advertiserTrackingEnabled;
  }
