...
public class EventResponse {
    ...
    public EventResponse status(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public EventResponse event(Integer event) {
        this.event = event;
        return this;
    }
    ...
    public EventResponse reason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public EventResponse errors(ErrorDetails errors) {
        this.errors = errors;
        return this;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!EventResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in EventResponse is not found in the"
                                        + " empty JSON string",
                                EventResponse.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `EventResponse` properties. JSON: %s",
